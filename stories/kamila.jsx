...
const Story = () => (
  ...
  <div>
    ...
    <p>
      <em>This week we got a chance to interview Kamila Lambert. She made a great transition from successful entrepreneur to working in the Tech Industry. Here is the interview:
      </em>
    </p>
    <p>
      <strong>Can you tell us a little bit about your background?
      </strong>
    </p>
    ...
    <p>
      <strong>What do you currently do?
      </strong>
    </p>
    <p>“I am currently a software engineer intern at Solv Health. I work on both their front-end and back-end code base. We use React for our front-end and Python for our back-end.”
      </p>
    <p>
      <strong>How did you learn how to code?
      </strong>
    </p>
    ...
    <p>
      <strong>Would you advise people to do a similar program or a bootcamp if they want to become software engineers?
      </strong>
    </p>
    ...
    <p>
      <strong>How did you get your internship?
      </strong>
    </p>
    <p>“Connections. Connections are extremely important and valuable; I don’t think that I would have even gotten an interview if I wasn’t referred for the position. I was referred for the position through someone that I met at Learners Guild and everything worked out. I am very thankful.”
      </p>
    <p>
      <strong>What was the interview process like?
      </strong>
    </p>
    ...
    <p>
      <strong>Do you feel like you’re contributing code and do you occasionally get the imposter syndrome? Since many new software engineers have told me that they feel it in the beginning.
      </strong>
    </p>
    ...
    <p>
      <em>For more awesome stories check out our 
      <a href="https://www.facebook.com/buzzybee.io/" target="_blank">facebook
    </a> and 
    <a href="https://medium.com/@buzzybeeio268" target="_blank">medium
    </a> page!
    </em>
    </p>
    </div>
