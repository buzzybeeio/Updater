...
const interview = () => (
  <div>
    ...
    <p>“I wanted to be a doctor in college so I went to school for that, but after doing an internship I realized that I didn’t want to be a doctor. I didn’t like it; it wasn’t for me. So I started on my own business teaching people how to garden and helping them with their gardens – I ended up selling that business because I couldn’t see myself doing it forever. I asked myself what I wanted to do, and I want to make things. Being a software engineer allows me to do that.”</p>
    <p><strong>What do you currently do?</strong></p>
    <p>“I am currently a software engineer intern at Solv Health. I work on both their front-end and back-end code base. We use React for our front-end and Python for our back-end.”</p>
    <p><strong>How did you learn how to code?</strong></p>
    <p>“I went through a coding program called Learners Guild. It’s a coding program in Oakland that’s ten months long. I did this program because I knew that fifteen-hour coding days at traditional three month bootcamps wasn’t going to work for me. Learning like that isn’t for me so I chose a longer program where I would have the time to allow the information to sink in. The program wasn’t exactly what I signed up for though, they didn’t offer as much support as they advertised and they were still trying to figure things out.”</p>
    <p><strong>Would you advise people to do a similar program or a bootcamp if they want to become software engineers?</strong></p>
    <p>“Yes and no. I think that if you know that a bootcamp is something for you, then definitely go for it but I think that bootcamps will only benefit a specific group of people. I think that the learning environment that you’re in is what is most beneficial to learning programming. I liked how everyone at Learners Guild was there to code. The most important part is the environment.”</p>
    <p><strong>How did you get your internship?</strong></p>
    <p>“Connections. Connections are extremely important and valuable; I don’t think that I would have even gotten an interview if I wasn’t referred for the position. I was referred for the position through someone that I met at Learners Guild and everything worked out. I am very thankful.”</p>
    <p><strong>What was the interview process like?</strong></p>
    <p>“For the first interview, I met up with one of the software engineers, walked around and talked about my background. He told me what the job entails of and what the company does, it was a non-technical interview. They sent me a coding challenge after, it was building a mobile app in React Native. I completed the challenge and they invited me for another interview. I thought that I was just going to meet the team, but it ended up being a technical interview with three software engineers, each meeting lasting for 45 minutes. They weren’t super intense problems but it was definitely challenging. They liked me and gave me an offer.”</p>
    <p><strong>Do you feel like you’re contributing code and do you occasionally get the imposter syndrome? Since many new software engineers have told me that they feel it in the beginning.</strong></p>
